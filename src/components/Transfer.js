...
export default function Transfer(props) {
    ...
    return (
        <section  className="container" id="c">
            <h1 style={{ "color": "white" }}> Transfer money</h1>
            <div className="form">
                <form onSubmit={handleTransfer}>
                    <input type="text" name='roll' onChange={onChange} placeholder='enter roll number to credit...' />
                    <input type="number" name="amount" onChange={onChange} min={0} placeholder="enter transfer amount.." />
                    <input type="password" name="pass" onChange={onChange} placeholder='enter password' />
